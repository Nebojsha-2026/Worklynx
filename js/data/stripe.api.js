// js/data/stripe.api.js
import { getSupabase } from "../core/supabaseClient.js";
import { getSession } from "../core/session.js";

// ✅ YOUR STRIPE CONFIGURATION (TEST MODE) - ALL CORRECT!
const STRIPE_CONFIG = {
  ...
  // ✅ YOUR ACTUAL PRICE IDs - ALL CORRECT NOW!
  prices: {
    tier_1: "price_1T1dKUJzqXVwu1nzXKbwW7wF", // $20/month - Starter
    tier_2: "price_1T1dLRJzqXVwu1nzAjRYN8L2", // $40/month - Professional
    tier_3: "price_1T1dM4JzqXVwu1nzrABlAZ2R", // $80/month - Business
  }
};
...
export async function createCheckoutSession({ tier, orgId, orgName }) {
  ...
  const successUrl = `${origin}/app/bo/dashboard.html?session_id={CHECKOUT_SESSION_ID}`;
